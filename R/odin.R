## Automatically generated by odin 1.3.2 - do not edit
odin_model_emanators_ <- R6::R6Class(
  ...
  private = list(
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_emanators_rhs_dde", package = "jICDMM")
        .C("odin_model_emanators_rhs_desolve", package = "jICDMM")
        .C("odin_model_emanators_initmod_desolve", package = "jICDMM")
        .C("odin_model_emanators_output_dde", package = "jICDMM")
      }
    },
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("odin_model_emanators_create", user, PACKAGE = "jICDMM")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("odin_model_emanators_set_user", private$ptr, user, PACKAGE = "jICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_emanators_initial_conditions", private$ptr, t, PACKAGE = "jICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_emanators_rhs_r", private$ptr, t, y, PACKAGE = "jICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_emanators_contents", private$ptr, PACKAGE = "jICDMM")
    },
...
odin_model_hrp2_ <- R6::R6Class(
  ...
  private = list(
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_hrp2_rhs_dde", package = "jICDMM")
        .C("odin_model_hrp2_rhs_desolve", package = "jICDMM")
        .C("odin_model_hrp2_initmod_desolve", package = "jICDMM")
        .C("odin_model_hrp2_output_dde", package = "jICDMM")
      }
    },
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_hrp2_create", user, PACKAGE = "jICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_hrp2_set_user", private$ptr, user, PACKAGE = "jICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_hrp2_initial_conditions", private$ptr, t, PACKAGE = "jICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_hrp2_rhs_r", private$ptr, t, y, PACKAGE = "jICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_hrp2_contents", private$ptr, PACKAGE = "jICDMM")
    },
...
odin_model_IVM_SMChet_ <- R6::R6Class(
  ...
  private = list(
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_IVM_SMChet_rhs_dde", package = "jICDMM")
        .C("odin_model_IVM_SMChet_rhs_desolve", package = "jICDMM")
        .C("odin_model_IVM_SMChet_initmod_desolve", package = "jICDMM")
        .C("odin_model_IVM_SMChet_output_dde", package = "jICDMM")
      }
    },
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_IVM_SMChet_create", user, PACKAGE = "jICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_IVM_SMChet_set_user", private$ptr, user, PACKAGE = "jICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_IVM_SMChet_initial_conditions", private$ptr, t, PACKAGE = "jICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_IVM_SMChet_rhs_r", private$ptr, t, y, PACKAGE = "jICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_IVM_SMChet_contents", private$ptr, PACKAGE = "jICDMM")
    },
...
odin_model_TBV_ <- R6::R6Class(
  ...
  private = list(
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_TBV_rhs_dde", package = "jICDMM")
        .C("odin_model_TBV_rhs_desolve", package = "jICDMM")
        .C("odin_model_TBV_initmod_desolve", package = "jICDMM")
        .C("odin_model_TBV_output_dde", package = "jICDMM")
      }
    },
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_TBV_create", user, PACKAGE = "jICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_TBV_set_user", private$ptr, user, PACKAGE = "jICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_TBV_initial_conditions", private$ptr, t, PACKAGE = "jICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_TBV_rhs_r", private$ptr, t, y, PACKAGE = "jICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_TBV_contents", private$ptr, PACKAGE = "jICDMM")
    },
...
odin_model_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             ...
             "d1", "dB", "dCA", "dCM", "dE", "dEL", "delayGam", "delayMos",
             "den", "dID", "dLL", "dPL", "eta", "fD0", "foi_age", "ft",
             "gamma1", "gammaD", "gammaL", "het_wt", "IB0", "IC0", "ICM_age",
             "ID0", "init_A", "init_D", "init_EL", "init_Ev", "init_IB",
             "init_ICA", "init_ICM", "init_ID", "init_Iv", "init_LL",
             "init_P", "init_PL", "init_S", "init_Sv", "init_T", "init_U",
             "irs_cov", "IRS_interval", "irs_loss", "itn_cov",
             "ITN_interval", "ITN_IRS_on", "itn_loss", "kB", "kC", "kD",
             "mu0", "muEL", "muLL", "muPL", "mv0", "na", "nh", "num_int",
             "omega", "p10", "p2", "phi0", "phi1", "pi", "PM", "Q0",
             "r_IRS0", "r_ITN0", "r_ITN1", "rA", "rD", "rel_foi", "rP", "rT",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_rhs_dde", package = "jICDMM")
        .C("odin_model_rhs_desolve", package = "jICDMM")
        .C("odin_model_initmod_desolve", package = "jICDMM")
        .C("odin_model_output_dde", package = "jICDMM")
      }
    },
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_create", user, PACKAGE = "jICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_set_user", private$ptr, user, PACKAGE = "jICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_initial_conditions", private$ptr, t, PACKAGE = "jICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_rhs_r", private$ptr, t, y, PACKAGE = "jICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_contents", private$ptr, PACKAGE = "jICDMM")
    },
